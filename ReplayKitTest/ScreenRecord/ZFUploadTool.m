...
- (instancetype)init {
    if(self = [super init]) {
        _faceTrack = [[ZYFaceTrack alloc] initWithCallBack:&callback pUser:(__bridge void * _Nonnull)(self)];
    }
    return self;
}
...
- (void)prepareToStart:(NSDictionary *)dict {
    ...
    if (!_url) {
        _url = @"rtmp://live.restream.io/live/re_2679636_559916c71a97585dd7d6";
    }
    [self lf];
}
- (void)lf {
