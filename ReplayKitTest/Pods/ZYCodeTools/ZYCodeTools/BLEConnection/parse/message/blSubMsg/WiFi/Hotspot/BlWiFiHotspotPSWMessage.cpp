...
#include "BlWiFiHotspotPSWMessage.h"
#include <assert.h>

NAMESPACE_ZY_BEGIN

BlWiFiHotspotPSWMessage::BlWiFiHotspotPSWMessage()
: zy::BlWiFiMessage()
{
...
bool BlWiFiHotspotPSWMessage::buildRequest()
{
    m_data.body.cmdType = ZYBIWiFiHotspotCmdPSW;
...
bool BlWiFiHotspotPSWMessage::buildResponse(BYTE* data, int size)
{
    int bodySize = sizeof(BlWiFiHotspotPSWMessage::MSG_BODY);
...
int BlWiFiHotspotPSWMessage::subType() const
{
    return ZYBIWiFiHotspotCmdPSW;
}
