...
//            options = @{[NSNumber numberWithBool:NO]:CBCentralManagerOptionShowPowerAlertKey};
            //非后台模式
...
-(void)retrieveConnectedPeripherals{
    CBUUID *uuid = [CBUUID UUIDWithString:@"FEE9"];
    CBUUID *uuid1 = [CBUUID UUIDWithString:@"0000FEE9-0000-1000-8000-00805F9B34FB"];
    NSArray *array = [centralManager retrieveConnectedPeripheralsWithServices:@[uuid,uuid1]];
    if (array.count > 0) {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"retrieveConnectedPeripherals" object:array];
    }
}
